...
export const districts = {
  ...
  '邢台市': ['襄都区', '信都区', '任泽区', '南和区', '临城县', '内丘县', '柏乡县', '隆尧县', '任县', '南和县', '宁晋县', '巨鹿县', '新河县', '广宗县', '威县', '清河县', '临西县', '南宫市', '沙河市'],
  ...
  '衡水市': ['桃城区', '枣强县', '武邑县', '武强县', '饶阳县', '安平县', '故城县', '景县', '阜城县', '冀州区', '深州市'],
  // 山西省
  ...
  '运城市': ['盐湖区', '临猗县', '万荣县', '闻喜县', '稷山县', '新绛县', '绛县', '垣曲县', '夏县', '芮城县', '永济市', '河津市'],
  ...
  // 辽宁省
  '沈阳市': ['和平区', '沈河区', '皇姑区', '大东区', '铁西区', '苏家屯区', '浑南区', '沈北新区', '于洪区', '辽中区', '康平县', '法库市', '新民市'],
  ...
  '吉林市': ['船营区', '昌邑区', '龙潭区', '丰满区', '永吉县', '蛟河市', '桦甸市', '舒兰市', '磐石市'],
  ...
  '大庆市': ['萨尔图区', '龙凤区', '让胡路区', '红岗区', '大同区', '肇州县', '肇源县', '杜尔伯特蒙古族自治县', '林甸县'],
  '伊春市': ['伊美区', '乌翠区', '友好区', '嘉荫县', '汤旺县', '丰林县', '大箐山县', '南岔县', '铁力市'],
  ...
  '芜湖市': ['镜湖区', '弋江区', '鸠江区', '湾沚区', '繁昌县', '南陵县', '无为市'],
  ...
  '青岛市': ['市南区', '市北区', '李沧区', '崂山区', '城阳区', '即墨区', '胶州市', '平度市', '莱西市', '黄岛区'],
  ...
  '信阳市': ['浉河区', '平桥区', '罗山县', '光山县', '新县', '商城县', '潢川县', '淮滨县', '息县', '固始县'],
  ...
  '十堰市': ['茅箭区', '张湾区', '郧阳区', '郧西县', '竹溪县', '竹山县', '房县', '丹江口市'],
  ...
  '随州市': ['曾都区', '随县', '广水市'],
  // 湖南省
  '长沙市': ['芙蓉区', '天心区', '岳麓区', '开福区', '雨花区', '望城区', '长沙县', '浏阳市', '宁乡市', '长沙县'],
  ...
  '常德市': ['武陵区', '鼎城区', '安乡县', '汉寿县', '澧县', '临澝县', '桃源县', '石门县', '津市市'],
  ...
  // 广西壮族自治区
  '南宁市': ['兴宁区', '青秀区', '江南区', '西乡塘区', '良庆区', '邕宁区', '隆安县', '马山县', '上林县', '宾阳县', '横州市'],
  '柳州市': ['城中区', '鱼峰区', '柳南区', '柳北区', '柳江区', '柳城县', '鹿寨县', '融安县', '融水苗族自治县', '三江侗族自治县'],
  '桂林市': ['秀峰区', '叠彩区', '象山区', '七星区', '雁山区', '临桂区', '阳朔县', '灵川县', '全州县', '兴安县', '永福县', '灌阳县', '资源县', '平乐县', '荔浦市', '龙胜各族自治县', '恭城瑶族自治县'],
  ...
  '普洱市': ['思茅区', '宁洱哈尼族彝族自治县', '墨江哈尼族自治县', '景东彝族自治县', '景谷傣族彝族自治县', '镇沅彝族哈尼族拉祜族自治县', '江城哈尼族彝族自治县', '澜沧拉祜族自治县', '孟连傣族拉祜族佤族自治县', '西盟佤族自治县'],
  ...
  '咸阳市': ['秦都区', '杨陵区', '渭城区', '三原县', '泾阳县', '乾县', '礼泉县', '永寿县', '长武县', '旬邑县', '淳化县', '武功县', '兴平市'],
  ...
  // 港澳台
  '香港特别行政区': ['中西区', '湾仔区', '东区', '南区', '油尖旺区', '深水埗区', '九龙城区', '黄大仙区', '观塘区', '荃湾区', '葵青区', '沙田区', '大埔区', '北区', '西贡区', '离岛区'],
  '澳门特别行政区': ['花地玛堂区', '花王堂区', '望德堂区', '大堂区', '风顺堂区', '嘉模堂区', '路氹填海区', '路环岛', '氹仔'],
  '台北市': ['中正区', '大同区', '中山区', '松山区', '大安区', '万华区', '信义区', '士林区', '北投区', '内湖区', '南港区', '文山区'],
  '新北市': ['板桥区', '汐止区', '新店区', '永和区', '中和区', '土城区', '树林区', '三重区', '新庄区', '芦洲区', '瑞芳区', '三峡区', '莺歌区', '淡水区', '万里区', '金山区'],
  '桃园市': ['桃园区', '中坜区', '平镇区', '八德区', '杨梅区', '龟山区', '龙潭区', '新屋区', '观音区', '新屋区', '复兴区', '大园区', '大溪区', '芦竹区'],
  '台中市': ['中区', '东区', '南区', '西区', '北区', '西屯区', '南屯区', '北屯区', '丰原区', '东势区', '大甲区', '清水区', '沙鹿区', '梧栖区', '后里区'],
  '台南市': ['中西区', '东区', '南区', '北区', '安平区', '安南区', '安北区', '永康区', '归仁区', '新化区', '新市区', '善化区', '新营区', '盐水区', '麻豆区'],
  '高雄市': ['楠梓区', '左营区', '鼓山区', '三民区', '盐埕区', '前金区', '新兴区', '苓雅区', '前镇区', '旗津区', '小港区', '凤山区', '林园区', '大寮区', '大树区', '仁武区']
}
